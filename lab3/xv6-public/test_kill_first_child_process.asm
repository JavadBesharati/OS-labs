 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 fc 08 00 00 	movzbl 0x8fc(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 a4 08 00 00 	jmp    *0x8a4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 9a 08 00 00       	mov    $0x89a,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 a8 0b 00 00       	mov    0xba8,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 a8 0b 00 00    	mov    %edx,0xba8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d a8 0b 00 00    	mov    0xba8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d a8 0b 00 00    	mov    0xba8,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 a8 0b 00 00    	mov    0xba8,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 a8 0b 00 00 ac 	movl   $0xbac,0xba8
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf ac 0b 00 00       	mov    $0xbac,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 ac 0b 00 00 ac 	movl   $0xbac,0xbac
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 b0 0b 00 00 00 	movl   $0x0,0xbb0
 7b2:	00 00 00 
    if(p->s.size >= nunits){
