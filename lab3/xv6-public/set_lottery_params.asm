...
_set_lottery_params:     file format elf32-i386
...
{  
  ...
  2b:	53                   	push   %ebx
  2c:	50                   	push   %eax
  2d:	e8 29 03 00 00       	call   35b <set_lottery_params>
 ...
 5c1:	a1 58 0a 00 00       	mov    0xa58,%eax
{
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 58 0a 00 00    	mov    %edx,0xa58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d 58 0a 00 00    	mov    0xa58,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 4f                	jae    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	8b 3d 58 0a 00 00    	mov    0xa58,%edi
 ...
 6ca:	e8 f1 fe ff ff       	call   5c0 <free>
  return freep;
 6cf:	8b 15 58 0a 00 00    	mov    0xa58,%edx
 ...
 717:	0a 00 00 
    base.s.size = 0;
 71a:	bf 5c 0a 00 00       	mov    $0xa5c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 72b:	c7 05 60 0a 00 00 00 	movl   $0x0,0xa60
 732:	00 00 00 
    if(p->s.size >= nunits){
