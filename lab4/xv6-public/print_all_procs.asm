...
_print_all_procs:     file format elf32-i386
...
main(int argc, char *argv[])
{
   ...
   3:	83 e4 f0             	and    $0xfffffff0,%esp
    print_all_procs();
   6:	e8 28 03 00 00       	call   333 <print_all_procs>
    exit();
...
00000343 <sem_acquire>:
SYSCALL(sem_acquire)
 343:	b8 1e 00 00 00       	mov    $0x1e,%eax
 348:	cd 40                	int    $0x40
 34a:	c3                   	ret    

0000034b <sem_release>:
SYSCALL(sem_release)
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 40e:	56                   	push   %esi
 40f:	57                   	push   %edi
 410:	e8 6e fe ff ff       	call   283 <write>
  while(--i >= 0)
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 485:	57                   	push   %edi
 486:	56                   	push   %esi
 487:	e8 f7 fd ff ff       	call   283 <write>
 ...
 4de:	e8 a0 fd ff ff       	call   283 <write>
        putc(fd, c);
 ...
 4ef:	57                   	push   %edi
 4f0:	56                   	push   %esi
 4f1:	e8 8d fd ff ff       	call   283 <write>
        putc(fd, c);
 ...
 59c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 59f:	e8 df fc ff ff       	call   283 <write>
        ap++;
 ...
 5e1:	a1 68 0a 00 00       	mov    0xa68,%eax
{
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 68 0a 00 00    	mov    %edx,0xa68
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 68 0a 00 00    	mov    0xa68,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d 68 0a 00 00    	mov    0xa68,%edi
 ...
 6d3:	e8 13 fc ff ff       	call   2eb <sbrk>
  if(p == (char*)-1)
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 68 0a 00 00    	mov    0xa68,%edx
 ...
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf 6c 0a 00 00       	mov    $0xa6c,%edi
    base.s.ptr = freep = prevp = &base;
