...
int main(int argc, char* argv[]){
  ...
  85:	50                   	push   %eax
  86:	50                   	push   %eax
  87:	68 ec 08 00 00       	push   $0x8ec
  8c:	6a 01                	push   $0x1
  8e:	e8 4d 04 00 00       	call   4e0 <printf>
        printf(1, "Please check if you entered an integer smaller than 1\n");
  93:	5a                   	pop    %edx
  94:	59                   	pop    %ecx
  95:	68 94 08 00 00       	push   $0x894
  9a:	6a 01                	push   $0x1
 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 469:	0f b6 92 6c 09 00 00 	movzbl 0x96c(%edx),%edx
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 559:	ff 24 85 14 09 00 00 	jmp    *0x914(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba 0a 09 00 00       	mov    $0x90a,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 1c 0c 00 00       	mov    0xc1c,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 1c 0c 00 00    	mov    %edx,0xc1c
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 1c 0c 00 00    	mov    %edx,0xc1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d 1c 0c 00 00    	mov    0xc1c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d 1c 0c 00 00    	mov    0xc1c,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 1c 0c 00 00    	mov    0xc1c,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 1c 0c 00 00    	mov    %edx,0xc1c
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 1c 0c 00 00 20 	movl   $0xc20,0xc1c
 7d7:	0c 00 00 
    base.s.size = 0;
 7da:	bf 20 0c 00 00       	mov    $0xc20,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 20 0c 00 00 20 	movl   $0xc20,0xc20
 7e6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 24 0c 00 00 00 	movl   $0x0,0xc24
 7f2:	00 00 00 
    if(p->s.size >= nunits){
