 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	56                   	push   %esi
 4a7:	e8 f7 fd ff ff       	call   2a3 <write>
 ...
 4fe:	e8 a0 fd ff ff       	call   2a3 <write>
        putc(fd, c);
 ...
 50f:	57                   	push   %edi
 510:	56                   	push   %esi
 511:	e8 8d fd ff ff       	call   2a3 <write>
        putc(fd, c);
 ...
 5bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5bf:	e8 df fc ff ff       	call   2a3 <write>
        ap++;
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba 94 07 00 00       	mov    $0x794,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6f3:	e8 13 fc ff ff       	call   30b <sbrk>
  if(p == (char*)-1)
