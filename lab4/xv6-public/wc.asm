 ...
 5b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5f5:	57                   	push   %edi
 5f6:	56                   	push   %esi
 5f7:	e8 f7 fd ff ff       	call   3f3 <write>
 ...
 64e:	e8 a0 fd ff ff       	call   3f3 <write>
        putc(fd, c);
 ...
 65f:	57                   	push   %edi
 660:	56                   	push   %esi
 661:	e8 8d fd ff ff       	call   3f3 <write>
        putc(fd, c);
 ...
 70c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 70f:	e8 df fc ff ff       	call   3f3 <write>
        ap++;
...
free(void *ap)
{
 ...
 751:	a1 60 0e 00 00       	mov    0xe60,%eax
{
 ...
 791:	5b                   	pop    %ebx
  freep = p;
 792:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 798:	5e                   	pop    %esi
 799:	5f                   	pop    %edi
 79a:	5d                   	pop    %ebp
 ...
 7c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7cc:	89 15 60 0e 00 00    	mov    %edx,0xe60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ec:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 82f:	73 4f                	jae    880 <malloc+0xa0>
    ...
    if(p == freep)
 831:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
 ...
 843:	e8 13 fc ff ff       	call   45b <sbrk>
  if(p == (char*)-1)
 ...
 85a:	e8 f1 fe ff ff       	call   750 <free>
  return freep;
 85f:	8b 15 60 0e 00 00    	mov    0xe60,%edx
 ...
 88c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 88f:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 ...
 89f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8a0:	c7 05 60 0e 00 00 64 	movl   $0xe64,0xe60
 8a7:	0e 00 00 
    base.s.size = 0;
 8aa:	bf 64 0e 00 00       	mov    $0xe64,%edi
    base.s.ptr = freep = prevp = &base;
 8af:	c7 05 64 0e 00 00 64 	movl   $0xe64,0xe64
 8b6:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8bb:	c7 05 68 0e 00 00 00 	movl   $0x0,0xe68
 8c2:	00 00 00 
    if(p->s.size >= nunits){
