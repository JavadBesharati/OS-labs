 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d5:	57                   	push   %edi
 4d6:	56                   	push   %esi
 4d7:	e8 f7 fd ff ff       	call   2d3 <write>
 ...
 52e:	e8 a0 fd ff ff       	call   2d3 <write>
        putc(fd, c);
 ...
 53f:	57                   	push   %edi
 540:	56                   	push   %esi
 541:	e8 8d fd ff ff       	call   2d3 <write>
        putc(fd, c);
 ...
 5ec:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5ef:	e8 df fc ff ff       	call   2d3 <write>
        ap++;
 ...
 631:	a1 e4 0a 00 00       	mov    0xae4,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 e4 0a 00 00    	mov    %edx,0xae4
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 e4 0a 00 00    	mov    %edx,0xae4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d e4 0a 00 00    	mov    0xae4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d e4 0a 00 00    	mov    0xae4,%edi
 ...
 723:	e8 13 fc ff ff       	call   33b <sbrk>
  if(p == (char*)-1)
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 e4 0a 00 00 e8 	movl   $0xae8,0xae4
 787:	0a 00 00 
    base.s.size = 0;
 78a:	bf e8 0a 00 00       	mov    $0xae8,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 e8 0a 00 00 e8 	movl   $0xae8,0xae8
 796:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 ec 0a 00 00 00 	movl   $0x0,0xaec
 7a2:	00 00 00 
    if(p->s.size >= nunits){
