...
_test_readers_writers:     file format elf32-i386
...
int main()
{
  ...
  18:	78 4b                	js     65 <main+0x65>
    {
        printf(2, "Error forking child!\n");
    }
    else if (pid == 0)
  1a:	75 24                	jne    40 <main+0x40>
    {
        int pid1 = fork();
  1c:	e8 ea 02 00 00       	call   30b <fork>
        if (pid1 == 0)
  21:	85 c0                	test   %eax,%eax
  23:	75 56                	jne    7b <main+0x7b>
        {
            int pid1 = fork();
  25:	e8 e1 02 00 00       	call   30b <fork>
            if (pid1 == 0)
  2a:	85 c0                	test   %eax,%eax
  2c:	75 76                	jne    a4 <main+0xa4>
            {
                writer(1, &c);
  2e:	50                   	push   %eax
  2f:	50                   	push   %eax
  30:	8d 45 c4             	lea    -0x3c(%ebp),%eax
  33:	50                   	push   %eax
  34:	6a 01                	push   $0x1
  36:	e8 f0 03 00 00       	call   42b <writer>
  3b:	83 c4 10             	add    $0x10,%esp
  3e:	eb 36                	jmp    76 <main+0x76>
            wait();
        }
    }
    else
    {
        int pid1 = fork();
  40:	e8 c6 02 00 00       	call   30b <fork>

        if (pid1 == 0)
  45:	85 c0                	test   %eax,%eax
  47:	74 49                	je     92 <main+0x92>
        {
            writer(0, &c);
        }
        else
  ...
  49:	50                   	push   %eax
  4a:	50                   	push   %eax
  4b:	8d 45 c4             	lea    -0x3c(%ebp),%eax
  4e:	50                   	push   %eax
  4f:	6a 00                	push   $0x0
  51:	e8 cd 03 00 00       	call   423 <reader>
            wait();
  56:	e8 c0 02 00 00       	call   31b <wait>
  5b:	83 c4 10             	add    $0x10,%esp
        }
        wait();
  5e:	e8 b8 02 00 00       	call   31b <wait>
  63:	eb 11                	jmp    76 <main+0x76>
        printf(2, "Error forking child!\n");
  65:	50                   	push   %eax
  66:	50                   	push   %eax
  67:	68 18 08 00 00       	push   $0x818
  6c:	6a 02                	push   $0x2
  ...
  76:	e8 98 02 00 00       	call   313 <exit>
            reader(1, &c);
  7b:	8d 45 c4             	lea    -0x3c(%ebp),%eax
  7e:	51                   	push   %ecx
  7f:	51                   	push   %ecx
  80:	50                   	push   %eax
  81:	6a 01                	push   $0x1
  83:	e8 9b 03 00 00       	call   423 <reader>
            wait();
  88:	e8 8e 02 00 00       	call   31b <wait>
  8d:	83 c4 10             	add    $0x10,%esp
  90:	eb e4                	jmp    76 <main+0x76>
            writer(0, &c);
  92:	8d 45 c4             	lea    -0x3c(%ebp),%eax
  95:	52                   	push   %edx
  96:	52                   	push   %edx
  97:	50                   	push   %eax
  98:	6a 00                	push   $0x0
  9a:	e8 8c 03 00 00       	call   42b <writer>
  9f:	83 c4 10             	add    $0x10,%esp
  a2:	eb ba                	jmp    5e <main+0x5e>
                reader(2, &c);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	8d 45 c4             	lea    -0x3c(%ebp),%eax
  a9:	50                   	push   %eax
  aa:	6a 02                	push   $0x2
  ac:	e8 72 03 00 00       	call   423 <reader>
                wait();
  b1:	e8 65 02 00 00       	call   31b <wait>
  b6:	83 c4 10             	add    $0x10,%esp
  b9:	eb bb                	jmp    76 <main+0x76>
  bb:	66 90                	xchg   %ax,%ax
  bd:	66 90                	xchg   %ax,%ax
  bf:	90                   	nop
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 569:	ff 24 85 38 08 00 00 	jmp    *0x838(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba 2e 08 00 00       	mov    $0x82e,%edx
        while(*s != 0){
