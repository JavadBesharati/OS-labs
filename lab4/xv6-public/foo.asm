 ...
 611:	a1 a0 0a 00 00       	mov    0xaa0,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 a0 0a 00 00    	mov    %edx,0xaa0
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 a0 0a 00 00    	mov    %edx,0xaa0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d a0 0a 00 00    	mov    0xaa0,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 a0 0a 00 00    	mov    0xaa0,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 a0 0a 00 00    	mov    %edx,0xaa0
}
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf a4 0a 00 00       	mov    $0xaa4,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 a4 0a 00 00 a4 	movl   $0xaa4,0xaa4
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 a8 0a 00 00 00 	movl   $0x0,0xaa8
 782:	00 00 00 
    if(p->s.size >= nunits){
