...
00000443 <sem_acquire>:
SYSCALL(sem_acquire)
 443:	b8 1e 00 00 00       	mov    $0x1e,%eax
 448:	cd 40                	int    $0x40
 44a:	c3                   	ret    

0000044b <sem_release>:
SYSCALL(sem_release)
 ...
 49c:	89 d1                	mov    %edx,%ecx
{
 ...
 50e:	56                   	push   %esi
 50f:	57                   	push   %edi
 510:	e8 6e fe ff ff       	call   383 <write>
  while(--i >= 0)
 ...
 549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 585:	57                   	push   %edi
 586:	56                   	push   %esi
 587:	e8 f7 fd ff ff       	call   383 <write>
 ...
 5de:	e8 a0 fd ff ff       	call   383 <write>
        putc(fd, c);
 ...
 5ef:	57                   	push   %edi
 5f0:	56                   	push   %esi
 5f1:	e8 8d fd ff ff       	call   383 <write>
        putc(fd, c);
 ...
 69c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 69f:	e8 df fc ff ff       	call   383 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 7d3:	e8 13 fc ff ff       	call   3eb <sbrk>
  if(p == (char*)-1)
