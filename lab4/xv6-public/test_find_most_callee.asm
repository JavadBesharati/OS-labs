 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba d9 07 00 00       	mov    $0x7d9,%edx
        while(*s != 0){
 ...
 611:	a1 e0 0a 00 00       	mov    0xae0,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 e0 0a 00 00    	mov    %edx,0xae0
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 e0 0a 00 00    	mov    %edx,0xae0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d e0 0a 00 00    	mov    0xae0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d e0 0a 00 00    	mov    0xae0,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 e0 0a 00 00    	mov    0xae0,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 e0 0a 00 00    	mov    %edx,0xae0
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 e0 0a 00 00 e4 	movl   $0xae4,0xae0
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf e4 0a 00 00       	mov    $0xae4,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 e4 0a 00 00 e4 	movl   $0xae4,0xae4
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 e8 0a 00 00 00 	movl   $0x0,0xae8
 782:	00 00 00 
    if(p->s.size >= nunits){
