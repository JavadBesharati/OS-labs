 ...
 579:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b5:	57                   	push   %edi
 5b6:	56                   	push   %esi
 5b7:	e8 f7 fd ff ff       	call   3b3 <write>
 ...
 60e:	e8 a0 fd ff ff       	call   3b3 <write>
        putc(fd, c);
 ...
 61f:	57                   	push   %edi
 620:	56                   	push   %esi
 621:	e8 8d fd ff ff       	call   3b3 <write>
        putc(fd, c);
 ...
 68b:	57                   	push   %edi
 68c:	56                   	push   %esi
 68d:	e8 21 fd ff ff       	call   3b3 <write>
        while(*s != 0){
 ...
 6cc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6cf:	e8 df fc ff ff       	call   3b3 <write>
        ap++;
 ...
 711:	a1 d4 0b 00 00       	mov    0xbd4,%eax
{
 ...
 751:	5b                   	pop    %ebx
  freep = p;
 752:	89 15 d4 0b 00 00    	mov    %edx,0xbd4
}
 758:	5e                   	pop    %esi
 759:	5f                   	pop    %edi
 75a:	5d                   	pop    %ebp
 ...
 789:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78c:	89 15 d4 0b 00 00    	mov    %edx,0xbd4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 3d d4 0b 00 00    	mov    0xbd4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ef:	73 4f                	jae    840 <malloc+0xa0>
    ...
    if(p == freep)
 7f1:	8b 3d d4 0b 00 00    	mov    0xbd4,%edi
 ...
 803:	e8 13 fc ff ff       	call   41b <sbrk>
  if(p == (char*)-1)
 ...
 81a:	e8 f1 fe ff ff       	call   710 <free>
  return freep;
 81f:	8b 15 d4 0b 00 00    	mov    0xbd4,%edx
 ...
 84c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 84f:	89 15 d4 0b 00 00    	mov    %edx,0xbd4
}
 ...
 85f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 d4 0b 00 00 d8 	movl   $0xbd8,0xbd4
 867:	0b 00 00 
    base.s.size = 0;
 86a:	bf d8 0b 00 00       	mov    $0xbd8,%edi
    base.s.ptr = freep = prevp = &base;
 86f:	c7 05 d8 0b 00 00 d8 	movl   $0xbd8,0xbd8
 876:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 879:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 87b:	c7 05 dc 0b 00 00 00 	movl   $0x0,0xbdc
 882:	00 00 00 
    if(p->s.size >= nunits){
