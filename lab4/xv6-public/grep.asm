...
000006a3 <sem_acquire>:
SYSCALL(sem_acquire)
 6a3:	b8 1e 00 00 00       	mov    $0x1e,%eax
 6a8:	cd 40                	int    $0x40
 6aa:	c3                   	ret    

000006ab <sem_release>:
SYSCALL(sem_release)
 ...
 6fc:	89 d1                	mov    %edx,%ecx
{
 ...
 76e:	56                   	push   %esi
 76f:	57                   	push   %edi
 770:	e8 6e fe ff ff       	call   5e3 <write>
  while(--i >= 0)
 ...
 7a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7e5:	57                   	push   %edi
 7e6:	56                   	push   %esi
 7e7:	e8 f7 fd ff ff       	call   5e3 <write>
 ...
 83e:	e8 a0 fd ff ff       	call   5e3 <write>
        putc(fd, c);
 ...
 84f:	57                   	push   %edi
 850:	56                   	push   %esi
 851:	e8 8d fd ff ff       	call   5e3 <write>
        putc(fd, c);
 ...
 8bb:	57                   	push   %edi
 8bc:	56                   	push   %esi
 8bd:	e8 21 fd ff ff       	call   5e3 <write>
        while(*s != 0){
 ...
 8fc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 8ff:	e8 df fc ff ff       	call   5e3 <write>
        ap++;
...
free(void *ap)
{
 ...
 941:	a1 00 13 00 00       	mov    0x1300,%eax
{
 ...
 981:	5b                   	pop    %ebx
  freep = p;
 982:	89 15 00 13 00 00    	mov    %edx,0x1300
}
 988:	5e                   	pop    %esi
 989:	5f                   	pop    %edi
 98a:	5d                   	pop    %ebp
 ...
 9b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9bc:	89 15 00 13 00 00    	mov    %edx,0x1300
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9dc:	8b 3d 00 13 00 00    	mov    0x1300,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a1f:	73 4f                	jae    a70 <malloc+0xa0>
    ...
    if(p == freep)
 a21:	8b 3d 00 13 00 00    	mov    0x1300,%edi
 ...
 a33:	e8 13 fc ff ff       	call   64b <sbrk>
  if(p == (char*)-1)
 ...
 a4a:	e8 f1 fe ff ff       	call   940 <free>
  return freep;
 a4f:	8b 15 00 13 00 00    	mov    0x1300,%edx
 ...
 a7c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a7f:	89 15 00 13 00 00    	mov    %edx,0x1300
}
 ...
 a8f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a90:	c7 05 00 13 00 00 04 	movl   $0x1304,0x1300
 a97:	13 00 00 
    base.s.size = 0;
 a9a:	bf 04 13 00 00       	mov    $0x1304,%edi
    base.s.ptr = freep = prevp = &base;
 a9f:	c7 05 04 13 00 00 04 	movl   $0x1304,0x1304
 aa6:	13 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 aa9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 aab:	c7 05 08 13 00 00 00 	movl   $0x0,0x1308
 ab2:	00 00 00 
    if(p->s.size >= nunits){
