...
00000423 <sem_acquire>:
SYSCALL(sem_acquire)
 423:	b8 1e 00 00 00       	mov    $0x1e,%eax
 428:	cd 40                	int    $0x40
 42a:	c3                   	ret    

0000042b <sem_release>:
SYSCALL(sem_release)
 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 565:	57                   	push   %edi
 566:	56                   	push   %esi
 567:	e8 f7 fd ff ff       	call   363 <write>
 ...
 5be:	e8 a0 fd ff ff       	call   363 <write>
        putc(fd, c);
 ...
 5cf:	57                   	push   %edi
 5d0:	56                   	push   %esi
 5d1:	e8 8d fd ff ff       	call   363 <write>
        putc(fd, c);
 ...
 67c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 67f:	e8 df fc ff ff       	call   363 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 79f:	73 4f                	jae    7f0 <malloc+0xa0>
    ...
    if(p == freep)
 7a1:	8b 3d c4 0b 00 00    	mov    0xbc4,%edi
 ...
 7b3:	e8 13 fc ff ff       	call   3cb <sbrk>
  if(p == (char*)-1)
 ...
 7ca:	e8 f1 fe ff ff       	call   6c0 <free>
  return freep;
 7cf:	8b 15 c4 0b 00 00    	mov    0xbc4,%edx
 ...
 7fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ff:	89 15 c4 0b 00 00    	mov    %edx,0xbc4
}
 ...
 80f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 c4 0b 00 00 c8 	movl   $0xbc8,0xbc4
 817:	0b 00 00 
    base.s.size = 0;
 81a:	bf c8 0b 00 00       	mov    $0xbc8,%edi
    base.s.ptr = freep = prevp = &base;
 81f:	c7 05 c8 0b 00 00 c8 	movl   $0xbc8,0xbc8
 826:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 829:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 82b:	c7 05 cc 0b 00 00 00 	movl   $0x0,0xbcc
 832:	00 00 00 
    if(p->s.size >= nunits){
