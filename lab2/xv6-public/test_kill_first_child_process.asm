...
int main(int argc, char* argv[]){
  ...
  2f:	53                   	push   %ebx
  30:	50                   	push   %eax
  31:	68 dc 07 00 00       	push   $0x7dc
  36:	6a 01                	push   $0x1
  38:	e8 53 04 00 00       	call   490 <printf>
  ...
  6c:	52                   	push   %edx
  6d:	52                   	push   %edx
  6e:	68 65 08 00 00       	push   $0x865
  73:	6a 01                	push   $0x1
  75:	e8 16 04 00 00       	call   490 <printf>
            exit();
  7a:	e8 94 02 00 00       	call   313 <exit>
            printf(1, "First child was killed successfully.\n");
  7f:	51                   	push   %ecx
  80:	51                   	push   %ecx
  81:	68 0c 08 00 00       	push   $0x80c
  86:	6a 01                	push   $0x1
  88:	e8 03 04 00 00       	call   490 <printf>
            printf(1, "Children count after first child was killed: %d\n", get_children_count());
  8d:	e8 31 03 00 00       	call   3c3 <get_children_count>
  92:	83 c4 0c             	add    $0xc,%esp
  95:	50                   	push   %eax
  96:	68 34 08 00 00       	push   $0x834
  9b:	6a 01                	push   $0x1
 ...
 3ec:	89 d1                	mov    %edx,%ecx
{
 ...
 419:	0f b6 92 ec 08 00 00 	movzbl 0x8ec(%edx),%edx
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 94 08 00 00 	jmp    *0x894(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba 8a 08 00 00       	mov    $0x88a,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 631:	a1 98 0b 00 00       	mov    0xb98,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 98 0b 00 00    	mov    %edx,0xb98
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 98 0b 00 00    	mov    %edx,0xb98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 98 0b 00 00    	mov    0xb98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 98 0b 00 00    	mov    0xb98,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 98 0b 00 00    	mov    0xb98,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 98 0b 00 00    	mov    %edx,0xb98
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 98 0b 00 00 9c 	movl   $0xb9c,0xb98
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 9c 0b 00 00       	mov    $0xb9c,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 9c 0b 00 00 9c 	movl   $0xb9c,0xb9c
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 a0 0b 00 00 00 	movl   $0x0,0xba0
 7a2:	00 00 00 
    if(p->s.size >= nunits){
