 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 79 07 00 00       	mov    $0x779,%edx
        while(*s != 0){
 ...
 5b1:	a1 80 0a 00 00       	mov    0xa80,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 80 0a 00 00    	mov    %edx,0xa80
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 80 0a 00 00    	mov    %edx,0xa80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 80 0a 00 00    	mov    0xa80,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 80 0a 00 00    	mov    %edx,0xa80
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 80 0a 00 00 84 	movl   $0xa84,0xa80
 707:	0a 00 00 
    base.s.size = 0;
 70a:	bf 84 0a 00 00       	mov    $0xa84,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 84 0a 00 00 84 	movl   $0xa84,0xa84
 716:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 88 0a 00 00 00 	movl   $0x0,0xa88
 722:	00 00 00 
    if(p->s.size >= nunits){
